...
export default function UserProfile({ user, onBack, isModal = false }: UserProfileProps) {
  const ProfileWrapper: React.ElementType = isModal ? ScrollArea : 'main';
  const wrapperProps = isModal ? {className: "max-h-[80vh] p-4 sm:p-6"} : {className: "flex-1 overflow-y-auto p-4 sm:p-6 space-y-6"};
